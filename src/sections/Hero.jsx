...
const Hero = () => {
  ...
  return (
    <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-[90vh] gap-10 max-container ">
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
    <p className="text-xl font-montserrat text-coral-red">
      Our summer collection
    </p>
    <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
      <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 rounded-xl">The New Arrival</span>
      <br />
    ...
    <div className="relative flex-1 flex justify-center items-center xl:min-h-sreen max-xl: py-40 bg-primary bg-hero bg-cover bg-center">
